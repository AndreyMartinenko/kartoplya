 ...
 * Implements custom search logic for templates and themes.
 */
class easyreviewsViewAction extends waViewAction
{
    ...
    public function getTheme()
    {
        ...
        waTheme::exists($theme_id) || $theme_id = 'default';
        return new waTheme($theme_id);
    }
}
